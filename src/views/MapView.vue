...
const regionData = {
  서울특별시: ["강남구", "강동구", "강북구", "강서구","종로구"],
  경기도: ["수원시", "성남시", "용인시", "고양시"],
  인천시: ["미추홀구", "남동구", "부평구", "계양구"],
  부산시: ["해운대구", "수영구", "동래구", "영도구"],
  대구시: ["달서구", "수성구", "중구", "북구"],
};
  ...
  <div class="flex flex-row items-center w-full h-[100vh] overflow-hidden ">
    ...
    <div class="relative flex flex-col justify-start w-full h-full mt-40">
     ...
     <!-- 검색 결과 -->
        ...
        <div class="text-xs px-4">서울특별시 종로구 기준</div>
        ...
        <div
          ...
          class="absolute z-20 w-[220px] h-[130px] top-10 left-0 border-2 border-gray-200 bg-white p-2">
          <RangeSlider
            v-model="state['가격']"
            style="width: 100%"
            exponential
            :max="1000000">
            <template #suffix>천만원</template>
          </RangeSlider>
